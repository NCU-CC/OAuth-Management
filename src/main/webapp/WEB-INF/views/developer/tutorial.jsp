		...
		<div id="preview">
			...
			<div class="box box-info">
				...
				<div class="box-body">
					<p>
						我們所有的服務皆是開源的，包括<a
							href="https://github.com/NCU-CC/API-Documentation"
							target="_blank">NCU API</a> ，並提供多個app作為使用NCU API的範例及其衍生服務。
					</p>
					<p>
			...
			<div class="box box-warning">
				...
				<div class="box-body">
					...
					<p>不管您開發的是網站還是智慧型裝置的應用，我們建議您將client_id、client_secret和api_tokens放置在自己的主機上，並透過這個主機完成呼叫api的工作。
			...
			<div class="box box-danger">
				...
				<div class="box-body">
					<p>
						每個NCU API皆有每月使用量限制，超過使用量將列入觀察名單，若有特殊需求請<a
							href="mailto:mobile@cc.ncu.edu.tw">來信</a>告知。
					</p>
